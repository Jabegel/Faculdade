...
int atualizarProduto(Produto produtos[], int tamanhoProduto, Carrinho carrinho[], int tamanhoCarrinho) {
    int codigoProduto;
...
// Verificacao se estamos selecionando o produto correto
    ...
    for (int i = 0; i < tamanhoCarrinho; i++) {
        if (carrinho[i].produto.codigo == codigoProduto) {
            carrinho[i].produto = produtos[pos];
        }
    }
    return tamanhoProduto;
}
// Para alteracao buscamos pelo codigo e alteramos apenas o nome e o preco, alem de atualizar no carrinho
    ...
    do {
        ...
        switch(opcao) {
            ...
            case 5:
                ...
                break;
            case 6:  
                tamanhoProduto = atualizarProduto(produto, tamanhoProduto, carrinho, tamanhoCarrinho);
                break;
            case 7:
